...
#add_to_envVar ${PROJECTDIR}/bin       PATH
add_to_envVar ${PROJECTDIR}/python    PATH
add_to_envVar ${PROJECTDIR}/python   PYTHONPATH
#add_to_envVar ${PROJECTDIR}/build/lib  LD_LIBRARY_PATH
